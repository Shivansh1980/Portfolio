...
export const shivanshResume = {
    ...
    projects: [
      {
        name: "Stock Market Prediction with LSTM Recurrent Neural Network",
        description:
      ...
      {
        name: "Dimensionality Reduction and Image Compression with Sparse Auto-Encoders (Deep Learning)",
        description:
    ...
    socialLinks: [
      ...
      },
      {
        name: "LinkedIn",
        icon: <LinkedIn />,
        url: "https://www.linkedin.com/in/shivansh-shrivastava-1980/",
      },
    ],
};
